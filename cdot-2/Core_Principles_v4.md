...
unsolved** (the retardation mechanism was demoted, OP-3; and the connecton foam-sea of
OP-14 gives Newtonian $1/r$ but not the MOND $\sqrt M$ — most likely dark matter is
needed for galaxies pending a weak-field cooperativity that has not been found). *This
document was given a surgical update reflecting Sessions 3–4 (conservation laws, the
relational principle, the OP-3 demotion, the $q_0$ result, and the OP-14 gravity
findings); a full reorganization around the relational principle of §0 is flagged as a
future task.*
